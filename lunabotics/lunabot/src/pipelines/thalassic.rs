...
pub fn spawn_thalassic_pipeline(
    ...
    let depth_map_buffer = Arc::new(DepthMapBuffer {
        depth_map: Mutex::new(
            vec![0; projection_size.x as usize * projection_size.y as usize].into_boxed_slice(),
        ),
        condvar: Condvar::new(),
    });
